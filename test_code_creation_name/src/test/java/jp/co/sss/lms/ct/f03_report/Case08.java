...
public class Case08 {
	...
	void test03() {
		...
		WebElement detailNumber = detail.get(2);
	...
	void test04() {
		List<WebElement> submitted = webDriver.findElements(By.className("btn-default"));
		WebElement submittedNumber = submitted.get(3);

		scrollTo("document.body.scrollHeight");

		submittedNumber.click();
	...
	void test05() {
		final WebElement report = webDriver.findElement(By.id("content_1"));
	...
	void test07() {
		List<WebElement> detail = webDriver.findElements(By.className("btn-default"));
		WebElement detailButton = detail.get(6);
